...
string13_replaced = string13.replace("python", "snake")
print(string13_replaced)
...
string17 = "  python  "
string17_stripped = string17.strip()
print(string17_stripped)

# TODO: Use the swapcase() method to swap the case of all characters in the string
# Example: Swap case of "Python"
string18 = "Python"
string18_swapped = string18.swapcase()
print(string18_swapped)
